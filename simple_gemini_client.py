#!/usr/bin/env python3
"""
Simple Gemini Client with Basic Memory
Uses simple file-based storage for conversations instead of complex vector stores
"""
...
class SimpleMemoryClient:
    """Simple file-based memory client"""
    
    def __init__(self):
        self.memory_file = MEMORY_FILE
        self.memories = self._load_memories()
        console.print("✅ [green]Connected to simple memory[/green]")
    ...
    def _load_memories(self) -> List[Dict]:
        ...
        try:
            ...
            console.print(f"⚠️ [yellow]Could not load memories: {e}[/yellow]")
        return []
    ...
    def _save_memories(self):
        ...
        try:
            ...
            console.print(f"❌ [red]Could not save memories: {e}[/red]")
    ...
    def search_memories(self, query: str, limit: int = 3) -> Dict[str, Any]:
        ...
        try:
            ...
            top_memories = [mem[1]["content"] for mem in scored_memories[:limit]]
...
class SimpleGeminiChat:
    """Gemini chat client with simple memory integration"""
    
    def __init__(self, api_key: str, memory_client: SimpleMemoryClient):
...
def display_welcome():
    ...
    welcome_text = """
[bold green]🤖 Simple Gemini + Memory Client[/bold green]

[blue]Smart AI assistant with long-term memory[/blue]
[dim]Powered by Google Gemini 2.0 Flash + Simple File Storage[/dim]
...
def display_stats(chat_client: SimpleGeminiChat):
...
def display_memories(memory_client: SimpleMemoryClient):
...
def search_memories_interactive(memory_client: SimpleMemoryClient):
...
def main():
    ...
    try:
        ...
        memory_client = SimpleMemoryClient()
        
        # Initialize chat client
        chat_client = SimpleGeminiChat(GEMINI_API_KEY, memory_client)
